...
import { useMovieCreditsQuery, useMovieDetailQuery } from '../../../shared/api/tmdbApi';
...
export const MovieDetailScreen = () => {
  ...
  const detailQuery = useMovieDetailQuery(id);
        ...
        <View style={styles.heroRow}>
          ...
          <View style={styles.heroText}>
            ...
            {detail.original_title && detail.original_title !== detail.title ? (
              <Text style={styles.originalTitle}>{detail.original_title}</Text>
            ) : null}
